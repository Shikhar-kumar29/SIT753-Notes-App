...
import { 
  FiPlus, FiSearch, FiFolder, FiArchive, FiTrash2, 
  FiMoreVertical, FiGrid, FiList, FiLayout 
} from 'react-icons/fi';
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex bg-slate-900 p-1 rounded-lg border border-slate-800">
                <button className="p-1.5 rounded-md bg-slate-800 text-slate-100 shadow-sm"><FiGrid className="w-4 h-4"/></button>
                <button className="p-1.5 rounded-md text-slate-500 hover:text-slate-300"><FiList className="w-4 h-4"/></button>
              </div>
            </div>
                ...
                {filteredNotes.map(note => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <button className="text-slate-500 hover:text-slate-300"><FiMoreVertical className="w-4 h-4"/></button>
                    </div>
              ...
              {filteredNotes.length === 0 && (
                <div className="col-span-full py-20 text-center">
                  <div className="bg-slate-900 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-800">
                    <FiFolder className="w-8 h-8 text-slate-700" />
                  </div>
